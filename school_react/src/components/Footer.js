...
// import linkedin from '../assets/twitterimg.png'
// import insta from '../assets/instagramimg.png'
    ...
    <section class="">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a class="text-body" href="/sdfsd">Link 1</a>
            </li>
            <li>
              <a class="text-body" href="/sdfsd">Link 2</a>
            </li>
            <li>
              <a class="text-body" href="/sdfsdf">Link 3</a>
            </li>
            <li>
              <a class="text-body" href="/dsfdsf">Link 4</a>
            </li>
          </ul>
        </div>
      </div>
