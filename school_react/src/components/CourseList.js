...
function CourseList() {
    ...
    const handleEdit = async (id) => {
      ...
      const handleDelete = async (id) => {
        try {
          ...
          const response = await fetch(`/SCM/course/delete/${id}/`, {
            method: 'DELETE'
          });
    ...
    return (
        <div className='table-container'>
          <div className='row'>
          <h2>Course Table</h2>
            <div className='col-md-3' style={{marginRight:'-100px',marginTop:'10px'}}><Link  className='buttonLink' to="/course/add">Add<i className="fa fa-plus" aria-hidden="true"></i></Link>
            </div>
